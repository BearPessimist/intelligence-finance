...
public class HfbConst {
    ...
    // 用户绑定同步回调，点击返回跳转的页面路径。
//    public static final String USERBIND_RETURN_URL = "http://localhost:3000/user";

    public static final String USERBIND_RETURN_URL = "http://aliyun:8889/user"; // nginx的转发路径
...
//    public static final String RECHARGE_RETURN_URL = "http://localhost:3000/user";
    public static final String RECHARGE_RETURN_URL = "http://aliyun:8889/user";
    ...
    // 提现同步回调
    public static final String WITHDRAW_RETURN_URL = "http://aliyun:8889/user";
